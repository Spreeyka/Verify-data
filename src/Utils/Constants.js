...
export const CONSTANTS = {
  ...
  CHART_2_CONSTANTS: [10.2, 10.1, 10.1, 10.1, 10.0, 10.0, 9.9, 9.9, 9.9, 9.8],
...
export const API = [
  ...
  `https://raw.githubusercontent.com/statisticspoland/sdg-indicators-pl/master/api/v1/globalne/1.json`,
  `https://raw.githubusercontent.com/statisticspoland/sdg-indicators-pl/master/api/v1/globalne/zamieszkanie_g.json`,
  `https://raw.githubusercontent.com/statisticspoland/sdg-indicators-pl/master/api/v1/krajowe/zamieszkanie_k.json`,
  `https://raw.githubusercontent.com/statisticspoland/sdg-indicators-pl/master/api/v1/custodian/desa-unsd.json`,
  `https://raw.githubusercontent.com/statisticspoland/sdg-indicators-pl/master/api/v1/custodian/ilo.json`,
  `https://raw.githubusercontent.com/statisticspoland/sdg-indicators-pl/master/api/v1/custodian/icao.json`,
  `https://raw.githubusercontent.com/statisticspoland/sdg-indicators-pl/master/api/v1/custodian/fao.json`,
];
